...
- **[System Use Cases, Engineering Diagrams & Operational Requirements Specification](file:///c:/Users/araba/Desktop/SmartTransit/docs/system_use_cases_and_engineering_diagrams_specification.md)**: Comprehensive formal specification containing hardware/sensor/telecom requirements (smartphones, GPS accuracy, Mascom/Orange/BTC network budget), complete UML diagrammatic suite (Use Case, Sequence, Activity, Level 0/1 DFD, State Machines, ERD), algorithmic formulations, and implementation roadmap for academic project defense.
- **[System Architecture Defense & Database Specification](file:///c:/Users/araba/Desktop/SmartTransit/docs/system_architecture_defense_and_database_specification.md)**: Formal defense document justifying the tripartite architecture (Driver App, Passenger App, Web Command Center) and database schema.
- **[Lecturer Defense Guide & 30-Second System Pitch](file:///c:/Users/araba/Desktop/SmartTransit/docs/lecturer_defense_guide_and_30s_system_pitch.md)**: Presentation scripts, Q&A defense playbook, and quick pitches for supervisor reviews.
