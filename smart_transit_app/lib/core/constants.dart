class AppConstants {
  // Configured Cloud / Production URL (Render, Railway, Cloudflare, etc.)
  static const String cloudServerUrl = 'https://smarttransit-backend.onrender.com';
  ...
  // Active Server URL currently in use by the app
